...
# =======================================================
# 1. Fix ROS2 APT key (TheConstruct resets this often)
# =======================================================
echo "🔑 Fixing ROS 2 repository key..."
sudo mkdir -p /etc/apt/keyrings

# Remove old or broken keys
...
# =======================================================
# 2. Install ROS2 base dependencies (only missing ones)
# =======================================================
